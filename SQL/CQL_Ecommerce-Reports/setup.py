...
if __name__ == "__main__":
    try:
        ...
        liked_prdt_id text,
        title text,
        PRIMARY KEY (liked_prdt_id, cust_id));"""
        ...
        customer_data_insert_query = "INSERT INTO e_commerce.Customer(cust_id, first_name, last_name) VALUES ('%s', '%s', '%s')"
        ...
        print("added data in customers")        
        #Inserting Product data in the table
        product_data_insert_query = "INSERT INTO e_commerce.Product(prdt_id, title) VALUES ('%s', '%s')"
        ...
        product_liked_by_customer_data_insert_query = "INSERT INTO e_commerce.Product_Liked_By_Customer(cust_id, first_name, last_name, liked_prdt_id, title) VALUES ('%s', '%s', '%s', '%s', '%s')"
